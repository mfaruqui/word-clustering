...
def rearrangeClusters(origMono, origBi, lang, langPair1, langPair2, langPair3, langPair4, monoPower, biPower):
        ...
        if len(lang.wordsInClusDict[origClass]) > 1:
            for possibleNewClass in lang.clusUniCount.iterkeys():
                if possibleNewClass != origClass:
                    ...
                    if biPower != 0:
                        ...
                        if langPair4 != None:
                            deltaBi += langPair4.calcTentativePerplex(word, origClass, possibleNewClass)
                    else:
                        deltaBi = 0.0
            ...
            if tempNewClass != origClass:
                ...
                if biPower != 0:
                    ...
                    if langPair4 != None:
                        langPair4.updateDistribution(word, origClass, tempNewClass)
...
def runOchClustering(lang1, lang2, lang3, lang4, lang5, lang12, lang21, lang32, lang23, lang42, lang24, lang52, lang25, monoPower, biPower):
 
    wordsExchanged = 9999
    iterNum = 0
    origMono, origBi = (0.0, 0.0)
    
    while ( (wordsExchanged > 0.001 * (lang1.vocabLen + lang2.vocabLen + lang3.vocabLen + lang4.vocabLen + lang5.vocabLen) or iterNum < 5) and wordsExchanged !=0 and iterNum <= 20):
        iterNum += 1
        wordsExchanged = 0
        wordsDone = 0
        ...
        wordsExchangedEn, origMono, origBi = rearrangeClusters(origMono, origBi, lang1, lang12, None, None, None, monoPower, biPower)
        ...
        wordsExchangedDe, origMono, origBi = rearrangeClusters(origMono, origBi, lang2, lang21, lang23, lang24, lang25, monoPower, biPower)
        sys.stderr.write('\nwordsExchanged: '+str(wordsExchangedDe)+'\n')
        
        sys.stderr.write('\n'+'IterNum: '+str(iterNum)+'\n'+'Mono: '+str(origMono)+' Bi: '+str(origBi)+' Total: '+str(origMono + origBi)+'\n')
        sys.stderr.write('\nRearranging French words...\n')
        # Move around words of language 3            
        wordsExchangedFr, origMono, origBi = rearrangeClusters(origMono, origBi, lang3, lang32, None, None, None, monoPower, biPower)
        sys.stderr.write('\nwordsExchanged: '+str(wordsExchangedFr)+'\n')
        
        sys.stderr.write('\n'+'IterNum: '+str(iterNum)+'\n'+'Mono: '+str(origMono)+' Bi: '+str(origBi)+' Total: '+str(origMono + origBi)+'\n')
        sys.stderr.write('\nRearranging Fourth words...\n')
        # Move around words of language 4            
        wordsExchangedFourth, origMono, origBi = rearrangeClusters(origMono, origBi, lang4, lang42, None, None, None, monoPower, biPower)
        sys.stderr.write('\nwordsExchanged: '+str(wordsExchangedFourth)+'\n')
        
        sys.stderr.write('\n'+'IterNum: '+str(iterNum)+'\n'+'Mono: '+str(origMono)+' Bi: '+str(origBi)+' Total: '+str(origMono + origBi)+'\n')
        sys.stderr.write('\nRearranging Fifth words...\n')
        # Move around words of language 5            
        wordsExchangedFifth, origMono, origBi = rearrangeClusters(origMono, origBi, lang5, lang52, None, None, None, monoPower, biPower)
        sys.stderr.write('\nwordsExchanged: '+str(wordsExchangedFifth)+'\n')
    
        wordsExchanged = wordsExchangedEn + wordsExchangedDe + wordsExchangedFr + wordsExchangedFourth + wordsExchangedFifth
...
def main(inputFileName1, alignFileName1, inputFileName2, alignFileName2, inputFileName3, alignFileName3, inputFileName4, alignFileName4, \
        mono1FileName, mono2FileName, \
        outputFileName, numClusInit, typeClusInit, fileLength, monoPower, biPower, edgeThresh1, edgeThresh2, edgeThresh3, edgeThresh4):
    ...
    = readBilingualData(fileLength, inputFileName4, alignFileName4, mono1FileName, mono2FileName,\
                        fifthWordDict, fifthBigramDict, deWordDict, deBigramDict)
    
    lang1, lang2, lang3, lang4, lang5, lang12, lang21, lang32, lang23, lang42, lang24, lang52, lang25 = \
                initializeLanguagePairObjets(\
                alignDictEnDe, alignDictFrDe, alignDictFourthDe, alignDictFifthDe, enWordDict, enBigramDict, deWordDict, deBigramDict,\
                frWordDict, frBigramDict, fourthWordDict, fourthBigramDict, fifthWordDict, fifthBigramDict, \
                numClusInit, typeClusInit,
                edgeThresh1, edgeThresh2, edgeThresh3, edgeThresh4)
    ...
    runOchClustering(lang1, lang2, lang3, lang4, lang5, lang12, lang21, lang32, lang23, lang42, lang24, lang52, lang25, monoPower, biPower)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i4", "--inputfile4", type=str, help="Joint parallel file of two languages; sentences separated by |||")
    ...
    parser.add_argument("-a4", "--alignfile4", type=str, help="alignment file of the parallel corpus")
    ...
    parser.add_argument("-e4", "--edgethresh4", type=float, default=0, help="thresh for edges to be considered for bi")
    ...
    inputFileName4 = args.inputfile4
    alignFileName4 = args.alignfile4
    ...
    edgeThresh4 = args.edgethresh4
    
    main(inputFileName1, alignFileName1, inputFileName2, alignFileName2, inputFileName3, alignFileName3, inputFileName4, alignFileName4, \
         mono1FileName, mono2FileName,\
         outputFileName, numClusInit, typeClusInit, fileLength, monoPower, biPower, edgeThresh1, edgeThresh2, edgeThresh3, edgeThresh4)